...
public class Main {
    ...
    private static final Marker SEARCH_HISTORY_MARKER = MarkerManager.getMarker("SEARCH_HISTORY");
    ...
    public static void main(String[] args) {
        ...
        for (; ; ) {
            try {
                ...
                LOGGER.info(SEARCH_HISTORY_MARKER, "Пользователь ввел маршрут от {} до {} ", from, to);
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            LOGGER.info(INPUT_ERROR_MARKER,"Станция не найдена: {}", line);
